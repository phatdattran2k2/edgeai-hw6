...
require the IMX219 camera. Their job is to catch the obvious broken
import graph or corrupted YOLO model file failures BEFORE the slower
Docker build job spends 10 min building an ARM64 image.
